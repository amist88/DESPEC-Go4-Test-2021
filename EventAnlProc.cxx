...
//   pAida.Decays.clear();
//   count++;
//   if(firstWR==-1 && pInput->fGe_WR!=0)firstWR= pInput->fGe_WR;
//        if(pInput->fGe_WR!=0) RealTime=( pInput->fGe_WR-firstWR)/1E9;
//     if(count % 25000 ==0) cout<<"Time of File is now " << RealTime << " s " <<  endl;
//         if (RealTime % 1000000000 == 0 && pInput->fGe_WR!=0){
//              cout << "\r";
//         cout<<"Time of File is now " << RealTime/10E9 << " s " <<" firstWR " <<firstWR << "  pInput->fGe_WR " << pInput->fGe_WR<<  endl;
//        cout <<"\t\t\t\t";
//        cout.flush();
//         }
...
//        hGe_Energy_GainMonitor= MakeTH2('D',"Germanium/Stats/Germanium_GainMonitor","Germanium Energy-Time Matrix",1240,16600,29000,2500,0,5000,"Time (minutes)","Ge Energy (keV)");
       ...
       hGe_Energy_GainMonitor= MakeTH2('D',"Germanium/Stats/Germanium_GainMonitor","Germanium Energy-Time Matrix",1240,16600,29000,2500,0,5000,"Time (seconds)","Ge Energy (keV)");
...
//            cout<<"det " << det <<endl;
       ...
       /*     
             if(firstWR==-1 && Ge_WR!=0)firstWR= Ge_WR;
        if(Ge_WR!=0) RealTime=( Ge_WR-firstWR)/1E9;
           if(RealTime>-1 && GeE_Cal[i]>0)  hGe_Energy_GainMonitor->Fill(RealTime,GeE_Cal[i]);
            */
